...
if __name__ == "__main__":
    ...
    dir_tr = Path(
        f'/home/nick/VScode-workspace/Pansharpening_datasets/WV3_Dataset/train/train_wv3-001.h5')
    dir_val = Path(
        f'/home/nick/VScode-workspace/Pansharpening_datasets/WV3_Dataset/val/valid_wv3.h5')
    # dir_test = Path(f'F:/Data/GaoFen-2/train/train_gf2-001.h5')
